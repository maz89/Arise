...
Route::post('/utilisateurs/authenticate', [App\Http\Controllers\UtilisateurController::class, 'authenticate'])->name('utilisateur_authenticate');
...
//----------------- Clients
    ...
    Route::get('/utilisateurs/', [App\Http\Controllers\UtilisateurController::class, 'index'])->name('utilisateur_list');
    Route::get('/utilisateurs/add', [App\Http\Controllers\UtilisateurController::class, 'add'])->name('utilisateur_add');
    Route::post('/utilisateurs/save', [App\Http\Controllers\UtilisateurController::class, 'store'])->name('utilisateur_store');

    Route::get('/utilisateurs/modifier/{id}', [App\Http\Controllers\UtilisateurController::class, 'edit'])->name('utilisateur_edit');
    Route::post('/utilisateurs/update/{id}', [App\Http\Controllers\UtilisateurController::class, 'update'])->name('utilisateur_update');
    Route::post('/utilisateurs/delete/{id}', [App\Http\Controllers\UtilisateurController::class, 'delete'])->name('utilisateur_delete');
