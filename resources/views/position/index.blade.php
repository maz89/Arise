                    ...
                    <div class="card" id="customerList">
                        <div class="card-header border-bottom-dashed">
                            ...
                            <div class="row g-4 align-items-center">
                                <div class="col-sm">
                                    <div>
                                        <h5 class="card-libelle mb-0">List of  positions </h5>
                                    </div>
                                </div>
                                <div class="col-sm-auto">
                                    <div>

                                        <button type="button" class="btn btn-success add-btn" data-bs-toggle="modal" id="create-btn" data-bs-target="#addPosition"><i class="ri-add-line align-bottom me-1"></i> Add Position </button>
                                  ...
                                  <td>
                                                    ...
                                                    <ul class="list-inline hstack gap-2 mb-0">
                                                        <li class="list-inline-item edit" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" libelle="Modifier">
                                                            <a href="" data-bs-toggle="modal" class="text-primary d-inline-block edit-item-btn modifierPosition ">
                                                                <i class="ri-pencil-fill fs-16"></i>
                                                            </a>
                                                        </li>

                                                        <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" libelle="Supprimer">
                                                            <a class="text-danger d-inline-block remove-item-btn supprimerPosition" data-bs-toggle="modal" href="">
                                        ...
                                        @else
                                            ...
                                            <div class="noresult" >
                                                <div class="text-center">
                                                    ...
                                                    <p class="text-muted"> We did not find any Positions  for you search.</p>
                    ...
                    success: function(data) {
                        ...
                        if(data.data.isValid)
                        {
                            ...
                            Swal.fire({
                                    position: 'top-end',
                                    icon: 'success',
                                    title: 'Position  update with success',
                                    showConfirmButton: false,
