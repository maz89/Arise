...
<!-- Default Size -->
<div class="modal animated fadeIn" id="addDeparture" tabindex="-1" role="dialog">
    <div class="modal-dialog " role="document" style="max-width: 700px">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="title" id="myModalLabel">Add   Departure    </h3>
            </div>
            <div class="modal-body">
                ...
                <form>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="date" id="date_departure" name="date_departure">
                            </div>

                            <span class="text-danger" id="erreurDate_departure">  </span>
                        </div>
                    </div>
                    ...
                    <input type="hidden" id="idDeparture">

                    <div class="text-center m-t-20">
                        <button class="btn btn-primary submit-btn" type="button" id="ajouterDeparture">Save </button>

                        <button class="btn btn-primary submit-btn" type="button" id="updateDeparture">Edit</button>


                        <button class="btn btn-danger submit-btn" type="button" id="annulerDeparture">Cancel  </button>
