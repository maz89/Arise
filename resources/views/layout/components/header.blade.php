            ...
            <div class="d-flex">
                ...
                <div class="navbar-brand-box horizontal-logo">
                    ...
                    <a href="index.html" class="logo logo-dark">
                        ...
                        <span class="logo-lg">
                            <img src="assets/images/logo.png" alt="" height="117">
                        </span>
                    </a>
                    -->
                        ...
                        <span class="d-flex align-items-center">
                            ...
                            <span class="text-start ms-xl-2">
                                ...
                                @php
                                    ...
                                    $user = \App\Models\Utilisateur::rechercheUtilisateurById( session()->get('LoginUser') )

                                @endphp
                                <span class="d-none d-xl-inline-block ms-1 fw-medium user-name-text">{{$user->nom}} </span>
                                <span class="d-none d-xl-block ms-1 fs-12 text-muted user-name-sub-text">{{\App\Models\Utilisateur::getRole($user->id)}}</span>
                            </span>
                        </span>
                    </button>
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <a class="dropdown-item" href="{{route('dashboard')}}""><i class="mdi mdi-calendar-check-outline text-muted fs-16 align-middle me-1"></i> <span class="align-middle">Dashboard </span></a>
